...
class ProductCategoryMasterViewController: FUIFormTableViewController, SAPFioriLoadingIndicator {
    ...
    override func viewDidAppear(_ animated: Bool) {
        ...
        if let window = UIApplication.shared.keyWindow {
            window.setVisual(["screen": "ProductCategory"])
        }
    }
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        cell.headlineText = productcategory.categoryName
        cell.footnoteText = productcategory.category
...
extension ProductCategoryMasterViewController: EntitySetUpdaterDelegate {
