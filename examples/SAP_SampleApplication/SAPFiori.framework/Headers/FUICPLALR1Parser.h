...
/**
 * The FUICPLALR1Parser class is a concrete implementation of FUICPParser based on the lookahead left-to-right parsing method with a one symbol lookahead.
 * 
 ...
 */
@interface FUICPLALR1Parser : FUICPShiftReduceParser
