...
/// <code>FUICalendarView</code> control extends <code>UIView</code> and provides APIs to add calendar functionality in your app with minimal effort. There are four variations of FUICalendarView based on how the data is displayed.
/// <h3>MonthView</h3>
...
/// <h3>MultipleSelectionView</h3>
/// <img src="../ReadmeImages/FUICalendar-MultipleSelectionView.png?raw=true" alt="FUICalendarView"/>
...
/// The cancel button.
/// This is iOS system “Cancel” bar button item.
...
- (NSInteger)numberOfRows SWIFT_WARN_UNUSED_RESULT SWIFT_DEPRECATED_MSG("", "numberOfRowsIn:");
/// Gets the number of rows to be displayed.
/// important:
...
/// cell.setTintColor(UIColor.red, for: .normal)
///
/// \endcodeNote that the display of the selections in the <code>valueLabel</code> is the
...
///
/// \endcode
SWIFT_CLASS("_TtC8SAPFiori28FUIObjectCollectionViewCell2")
...
/// \param _ FUIWelcomeScreen instance
///
...
/// The key name of the property.
@property (nonatomic, copy) NSString * _Nullable keyName;
/// The <code>UILabel</code> displaying the key name field.
@property (nonatomic, readonly, weak) IBOutlet UILabel * _Null_unspecified keyLabel;
...
/// <ul>
///   <li>
///     <code>isEditable</code>: Indicates if the cell’s value may be modified.  Defaults to <code>true</code>.  When the cell is editable, the key and value are arranged vertically in a stack, otherwise they are arranged horizontally.
///   </li>
///   <li>
///     <code>alternativeInputButton</code>: A <code>FUIButton</code> that manages an alternative method to fill the textField.
///   </li>
///   <li>
///     <code>isAlternativeInputEnabled</code>: A <code>Bool</code> that shoes or hides the <code>alternativeInputButton</code>.  This button will show if <code>isAlternativeInputEnabled</code> and <code>isEditable</code> are <code>true</code>.
///   </li>
/// </ul>
/// Color settings:
/// Setting tintColor for add button for a state using setTintColor(_:for:) api. Currently <code>disabled</code> and <code>normal</code> are supported.
...
@interface FUITextFieldFormCell : FUIInlineValidationTableViewCell <UITextFieldDelegate>
/// The value of the property.
